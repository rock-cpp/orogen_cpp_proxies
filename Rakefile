...
package_name = 'orogen_cpp_proxies'
begin
    require 'hoe'
    ...
    hoe_spec = Hoe.spec package_name do
        self.version = ''
        self.developer "Janosch Machowinski", "Janosch.Machowinski@dfki.de"
        self.extra_deps <<
            ['rake', '>= 0.8.0'] <<
            ["hoe",     ">= 3.0.0"] <<
            ["hoe-yard",     ">= 0.1.2"]

        self.summary = 'Orogen Plugin that allows the generation of C++ Task Proxies'
